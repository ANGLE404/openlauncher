                                ...
                                when (destination) {
                                    ...
                                    NavDestination.APP_LIBRARY -> AppLibraryScreen(
                                        ...
                                        carPlayPickerLabel  = when (appPickerTarget) {
                                            com.openlauncher.app.viewmodel.LauncherViewModel.AppPickerTarget.ANDROID_AUTO -> "选择 Android Auto 应用"
                                            com.openlauncher.app.viewmodel.LauncherViewModel.AppPickerTarget.PIP          -> "选择画中画应用"
                                            com.openlauncher.app.viewmodel.LauncherViewModel.AppPickerTarget.RADIO        -> "选择收音机应用"
                                            else -> "选择 CarPlay 应用"
                                        },
                                        accent              = accent,
