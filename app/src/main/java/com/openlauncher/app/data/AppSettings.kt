...
fun defaultShortcuts() = listOf(
    ShortcutConfig(label = "收音机", isDefault = true, defaultIcon = DefaultShortcutIcon.RADIO),
    ShortcutConfig(label = "相机", isDefault = true, defaultIcon = DefaultShortcutIcon.CAMERA),
    ShortcutConfig(label = "音乐", isDefault = true, defaultIcon = DefaultShortcutIcon.MUSIC),
    ShortcutConfig(label = "电话", isDefault = true, defaultIcon = DefaultShortcutIcon.PHONE)
)
